set_property IOSTANDARD LVCMOS33 [get_ports {a[3:0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {b[3:0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {c[4:0]}]

set_property LOC P1 [get_ports {a[0]}]
set_property LOC P2 [get_ports {a[1]}]
