...
HD_PWD='C:/Users/Anderson/AXI Lite_adder_0122/AXI Lite_adder_0122.runs/design_1_axi_adder_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_adder_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_adder_0_1.tcl
